...
--导出高铁标识，红外标识
Insert into WY_COLUMNS_CONFIG (ID,CN_NAME,EN_NAME,TYPE,ORDERNO,REMARK,ENABLE,ENEDIT,COMBOBOX) values (294,'高铁标识','HIGHTRAIN_FLAG',1,16,'wy_bts',0,0,0);
Insert into WY_COLUMNS_CONFIG (ID,CN_NAME,EN_NAME,TYPE,ORDERNO,REMARK,ENABLE,ENEDIT,COMBOBOX) values (295,'红线内外','REDLINE_FLAG',1,16,'wy_bts',0,0,0);
Insert into WY_COLUMNS_CONFIG (ID,CN_NAME,EN_NAME,TYPE,ORDERNO,REMARK,ENABLE,ENEDIT,COMBOBOX) values (296,'高铁标识','HIGHTRAIN_FLAG',2,106,'wy_bbu',0,0,0);
Insert into WY_COLUMNS_CONFIG (ID,CN_NAME,EN_NAME,TYPE,ORDERNO,REMARK,ENABLE,ENEDIT,COMBOBOX) values (297,'红线内外','REDLINE_FLAG',2,106,'wy_bbu',0,0,0);
Insert into WY_COLUMNS_CONFIG (ID,CN_NAME,EN_NAME,TYPE,ORDERNO,REMARK,ENABLE,ENEDIT,COMBOBOX) values (298,'高铁标识','HIGHTRAIN_FLAG',8,10,'wy_tunel',0,0,0);
Insert into WY_COLUMNS_CONFIG (ID,CN_NAME,EN_NAME,TYPE,ORDERNO,REMARK,ENABLE,ENEDIT,COMBOBOX) values (299,'红线内外','REDLINE_FLAG',8,11,'wy_tunel',0,0,0);
Insert into WY_COLUMNS_CONFIG (ID,CN_NAME,EN_NAME,TYPE,ORDERNO,REMARK,ENABLE,ENEDIT,COMBOBOX) values (300,'高铁标识','HIGHTRAIN_FLAG',4,203,'wy_cell',0,0,0);
Insert into WY_COLUMNS_CONFIG (ID,CN_NAME,EN_NAME,TYPE,ORDERNO,REMARK,ENABLE,ENEDIT,COMBOBOX) values (301,'红线内外','REDLINE_FLAG',4,203,'wy_cell',0,0,0);
Insert into WY_COLUMNS_CONFIG (ID,CN_NAME,EN_NAME,TYPE,ORDERNO,REMARK,ENABLE,ENEDIT,COMBOBOX) values (302,'高铁标识','HIGHTRAIN_FLAG',6,14,'wy_cell',0,0,0);
Insert into WY_COLUMNS_CONFIG (ID,CN_NAME,EN_NAME,TYPE,ORDERNO,REMARK,ENABLE,ENEDIT,COMBOBOX) values (303,'红线内外','REDLINE_FLAG',6,14,'wy_cell',0,0,0);
alter table wy_cell add HIGHTRAIN_FLAG varchar2(128);
alter table wy_cell add REDLINE_FLAG number(1);
--添加索引
--wy_bts
