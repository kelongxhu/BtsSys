...
public class FileRealPath {
	...
	public static String getPath()
	{
		try
		{
			String fileRealPath = FileRealPath.getFullPathRelateClass("../", FileRealPath.class);
			fileRealPath = fileRealPath.substring(0, fileRealPath.indexOf("WEB-INF"));
			return fileRealPath;
		}
		catch(Exception exc)
		{
