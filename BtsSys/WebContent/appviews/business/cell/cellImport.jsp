    ...
    <script type="text/javascript">
        $(function() {
            $("#uploadify").uploadify({
                ...
                uploader      : '${ctx}/businessjson/importCellInputData.action;jsessionid=${pageContext.session.id}',
                fileObjName     : 'file',
                fileSizeLimit   : 0,
                successTimeout:6000,
                multi  : false,
                ...
                onUploadSuccess : function(file, data, response) {
                    ...
                    if (data.result == 1) {
                        ...
                        $("#msg").html("文件：" + file.name + "导入过程中出现异常!导入成功条数："+data.sucess);
                    }
                }
            });
        });
