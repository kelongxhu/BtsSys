			...
			.validate(
					{
						submitHandler : function(form) {
							 jQuery(form).ajaxSubmit(function(json){
                                 ...
                                 window.location.href="${ctx}/business/abandonBts.action?typeId="+${typeId}
							 });
						}
					});
        });
...
<div id="main_2">
    ...
    <div class="content">
        ...
        <form id="form1" method="post" style="padding-bottom: 15px;padding-top: 20px;" action="${ctx}/businessjson/editAbandoned.action">
