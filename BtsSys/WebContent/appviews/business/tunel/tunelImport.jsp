    ...
    <script type="text/javascript">
        $(function() {
            $("#uploadify").uploadify({
                ...
                uploader      : '${ctx}/businessjson/importTunelInputData.action;jsessionid=${pageContext.session.id}',
                fileObjName     : 'file',
                fileSizeLimit   : 0,
                successTimeout:600,
                multi  : false,
...
<div id="main_2">
    ...
    <div class="content">
        ...
        <div class="form-actions">
            <button class="btn btn-info" type="button" onclick="uploadifyUpload();"><i class="icon-ok icon-white"></i>上传
            </button>
