...
<!-- 标题 -->
	...
	<div class="main_title_2">
              <p class="main_title_p"><img src="${ctx}/layouts/image/ico_arrow.gif"></img>增加天线库信息</p>
	</div>
	<div class="content">
	<form method="post" name="form1" id="form1" action="${ctx}/schooljson/addAirLib.action">
		<table cellpadding="0" cellspacing="0" class="tab_1" >
            <tr>
                <th width="150px"><span style="color: red;">*</span>天线型号:</th>
                <td width="300px">
					<input name="airLib.airModel" id="airModel" type="text" class="required"/>
				</td>
            ...
            <tr>
             ...
             <tr>
				...
				<td>
					<input name="airLib.degree" id="degree" type="text" class="{required:true,number:true}"/>
				</td>
				<th>频率范围(单位MHz):</th>
                <td>
					<input name="airLib.freq" type="text" id="freq" class="{number:true}"/> 
				</td>           
			</tr>
			<tr>
				<th>频带宽度(单位MHz):</th>
                <td>
					<input name="airLib.trapWidth" type="text" id="trapWidth" class="{number:true}" /> 
				</td>
				<th>天线增益(单位dBi)：</th>
				<td>
					<input name="airLib.airPlus" type="text" id="airPlus" class="{number:true}"/> 
				</td>
			</tr>
			<tr>
				<th>天线类型：</th>
            ...
            <tr>
				<th>水平波瓣(单位度)：</th>
				<td>
					<input name="airLib.flatLobe" type="text" id="flatLobe" class="{number:true)"/>
				</td>
				<th> 垂直波瓣（单位度）：</th>
				<td>
					<input name="airLib.uplobe" type="text" id="uplobe" class="{number:true}"/>
				</td>
			</tr>
				<tr>
				...
				<th>输入阻抗（单位欧姆）：</th>
				<td>
					<input name="airLib.inputDrag" type="text" id="inputDrag" class="{number:true}"/>
				</td>
				<th>天线前后比（单位dB）：</th>
				<td>
					<input name="airLib.wireScale" type="text" id="wireScale" class="{number:true}"/>
				</td>
            </tr>
            <tr>		
				<th>驻波系数：</th>
				<td>
					<input name="airLib.standingWave" type="text" id="standingWave" class="{number:true}"/>
				</td>
				<th>俯仰上旁瓣抑制（单位dB）：</th>
				<td>
					<input name="airLib.pitchUp" type="text" id="pitchUp" class="{number:true}"/>
				</td>
            </tr>
             <tr>
				...
				<th>俯仰下旁瓣抑制（单位dB）：</th>
				<td>
					<input name="airLib.pitchDown" type="text" id="pitchDown" class="{number:true}"/>
				</td>
            </tr>
            <tr>
				<th>备注：</th>
				<td colspan="3">
					<textarea name="airLib.remark"  id="remark"></textarea>
				</td>
            </tr>
         </table>
