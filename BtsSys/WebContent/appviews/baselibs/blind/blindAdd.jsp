...
<!-- 标题 -->
	...
	<div class="main_title_2">
              <p class="main_title_p"><img src="${ctx}/layouts/image/ico_arrow.gif"/>增加盲点库信息</p>
	</div>
	<div class="content">
	<form method="post" name="form1" id="form1" action="${ctx}/schooljson/addBlind.action">
		<table cellpadding="0" cellspacing="0" class="tab_1" >
             <tr>
                <th><span style="color: red;">*</span>盲点名称：</th>
				<td>
					<input name="wyBlind.name" id="name" type="text" class="required"/>
				</td>
				<th width="150px"><span style="color: red;">*</span>区县:</th>
                <td width="300px">
					<input name="countryIdVal" id="countryIdVal" type="text" class="required" style="width: 200px;"/>
            ...
            <tr>
				...
				<td>
					...
					<input name="wyBlind.gridType" id="gridType" type="hidden" />
				</td>				
            </tr>
             <tr>
                <th><span style="color: red;">*</span>经度：</th>
				<td>
					<input name="wyBlind.longitude" id="longitude" type="text" class="required number"/>
				</td>
				<th><span style="color: red;">*</span>纬度:</th>
                <td>
					<input name="wyBlind.latitude" type="text" id="latitude" class="required number" />
				</td>
			</tr>
			<tr>
                ...
                <td>
					...
					<input name="wyBlind.blindType1" type="hidden" id="blindType1"/>
				</td>
				<th>区域类型2:</th>
                <td>
					<input name="blindType2Val" type="text" id="blindType2Val"/>
					<input name="wyBlind.blindType2" type="hidden" id="blindType2"/>
				</td>				
			</tr>
			<tr>
			...
			<tr>
                ...
                <td>
					...
					<input name="wyBlind.solType" type="hidden" id="solType" />
				</td>			
				<th>辅助手段:</th>
                <td>
					<input name="assistTypeVal" type="text" id="assistTypeVal"/>
					<input name="wyBlind.assistType" type="hidden" id="assistType">
				</td>
			</tr>
			<tr>
				<th><span style="color: red;">*</span>形成原因：</th>
				<td>
					<input name="wyBlind.causesBy" id="causesBy" type="text" class="required"/>
				</td>
                <th>有无规划站:</th>
                <td>
                    <input name="isPlanVal" type="text" id="isPlanVal" />
                    <input name="wyBlind.isPlan" type="hidden" id="isPlan" />
                </td>
			</tr>
			<tr>
				<th><span style="color: red;">*</span>标志建筑：</th>
				<td>
					<input name="wyBlind.landMark" id="landMark" type="text" class="required"/>
				</td>
            	<th><span style="color: red;">*</span>地址：</th>
				<td>
					<input name="wyBlind.address" id="address" type="text" class="required"/>
				</td>
			</tr>
			<tr>
				<th>计划解决时间:</th>
                <td>
					<input name="wyBlind.planSolutionTime" type="text" id="planSolutionTime" />
				</td>
				<th>实际解决时间:</th>
                <td>
					<input name="wyBlind.realSolutionTime" type="text" id="realSolutionTime" />
				</td>
			</tr>
			 <tr>
				<th>备注：</th>
				<td colspan="3">
					<textarea name="wyBlind.remarks"  id="remarks"></textarea>
				</td>
            </tr>
            <tr>
			   	<td></td>
