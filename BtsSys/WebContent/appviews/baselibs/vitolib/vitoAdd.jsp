...
<!-- 标题 -->
	...
	<div class="main_title_2">
              <p class="main_title_p"><img src="${ctx}/layouts/image/ico_arrow.gif"></img>增加乡镇库信息</p>
	</div>
	<div class="content">
	<form method="post" name="form1" id="form1" action="${ctx}/schooljson/addVitoLib.action">
		<table cellpadding="0" cellspacing="0" class="tab_1" >
            <tr>
                ...
                <td colspan="3">
					...
					<input name="vitoLib.countryId" id="countryId" type="hidden"/>
				</td> 		
            </tr>
            ...
            <tr>
				...
				<td colspan="3">
					<input name="vitoLib.name" id="name" type="text" class="{required:true}"/>
				</td>
			</tr>
			<tr>
				<th><span style="color: red;">*</span>中心GPS经度:</th>
                <td>
					<input name="vitoLib.gpsLong" type="text" id="gpsLong" class="{number:true}"/> 
				</td>
				<th><span style="color: red;">*</span>中心GPS纬度:</th>
                <td>
					<input name="vitoLib.gpsLat" type="text" id="gpsLat" class="{number:true}" /> 
				</td>           
			</tr>
			 <tr>
				<th><span style="color: red;">*</span>电信CDMA1X2000网络覆盖率(%)：</th>
				<td>
					<input name="vitoLib.cmda1xCovgrate" id="cmda1xCovgrate" type="text" class="{required:true}"/>
				</td>
				<th><span style="color: red;">*</span>移动GSM网络覆盖率(%)：</th>
				<td>
					<input name="vitoLib.mobgsmCovgrate" id="mobgsmCovgrate" type="text" class="{required:true}"/>
				</td>
            </tr>
             <tr>
				<th><span style="color: red;">*</span>电信与移动覆盖差值(%)：</th>
				<td>
					<input name="vitoLib.covgDifCovgrate" id="covgDifCovgrate" type="text" class="{required:true}"/>
				</td>
				<th><span style="color: red;">*</span>联通GSM网络覆盖率(%)：</th>
				<td>
					<input name="vitoLib.unicgsmCovgrate" id="unicgsmCovgrate" type="text" class="{required:true}"/>
				</td>
            </tr>
             <tr>
				<th><span style="color: red;">*</span>电信EVDO网络覆盖率(%)：</th>
				<td>
					<input name="vitoLib.evdoCovgrate" id="evdoCovgrate" type="text" class="{required:true}"/>
				</td>
				 <th><span style="color: red;">*</span>电信CDMA1X2000语音MOS值：</th>
				<td>	
					<input name="vitoLib.cdma1xMos" id="cdma1xMos" type="text" class="{required:true}"/>
				</td>
            </tr>       
            <tr>
				...
				<td>	
					<input name="vitoLib.mobgsmMos" id="mobgsmMos" type="text" class="{required:true}"/>
				</td>
             	 <th><span style="color: red;">*</span>联通GSM语音MOS值：</th>
				<td>	
					<input name="vitoLib.unicgsmMos" id="unicgsmMos" type="text" class="{required:true}"/>
				</td>
			</tr>
			<tr>
				...
				<td>	
					<input name="vitoLib.testuser" id="testuser" type="text" class="{required:true}"/>
				</td>
			</tr>
			<tr>
			<th>备注：</th>
			<td colspan="3">
					<textarea name="vitoLib.remark"  id="remark"></textarea>
			</td>
			</tr>
            </table>
