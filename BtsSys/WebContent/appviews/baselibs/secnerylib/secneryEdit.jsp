...
$(function(){
	...
	$.post("${ctx}/schooljson/initCountryTree.action", function(
			...
			treeCombox.selectValue('${secneryLib.countryId}');
	});
	//初始化控件
   ...
   //初始化景区级别
	...
	$.getJSON(typeURL1, 
		function(data){
			...
			sl1.selectValue('${secneryLib.sceLevel}');
		}
	);
...
<!-- 标题 -->
	...
	<div class="main_title_2">
              <p class="main_title_p"><img src="${ctx}/layouts/image/ico_arrow.gif"></img>编辑景区库信息</p>
	</div>
	<div class="content">
	<form method="post" name="form1" id="form1" action="${ctx}/schooljson/editSecneryLib.action">
		<table cellpadding="0" cellspacing="0" class="tab_1" >
            <tr>
                ...
                <td width="300px">
					...
					<input name="secneryLib.id" id="id" type="hidden" value="${secneryLib.id}"/>
				</td>
            </tr>
            <tr>
           		<th><span style="color: red;">*</span>景区名称：</th>
				<td>
					<input name="secneryLib.sceName" id="sceName" type="text" class="required" value="${secneryLib.sceName}"/>
				</td>
            </tr>
             <tr>
			...
			<tr>
                ...
                <td>
					<input name="secneryLib.longitude" type="text" id="longitude" class="{number:true}" value="${secneryLib.longitude}"/> 
				</td>           
			</tr>
			<tr>
				<th><span style="color: red;">*</span>景区中心纬度:</th>
                <td>
					<input name="secneryLib.latitude" type="text" id="latitude" class="{number:true}" value="${secneryLib.latitude}"/> 
				</td>
			</tr>
			 <tr>
				<th>备注：</th>
				<td>
					<textarea name="secneryLib.remark"  id="remark">${secneryLib.remark}</textarea>
				</td>
            </tr>
         </table>
